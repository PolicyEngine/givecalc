...
3. How much does your donation actually cost you? (It's probably less than you think)

---

## Email Body

**Planning your year-end giving? Know your true cost.**

Most donation calculators give you a simple estimate: "You're in the 24% bracket, so you save 24 cents per dollar donated."
...
**[givecalc.org](https://givecalc.org)** — Free, no signup required

---

### Support PolicyEngine

GiveCalc is free because PolicyEngine is a 501(c)(3) nonprofit. Our open-source tax and benefit models power research for congressional offices, think tanks, and journalists.

**[Make a tax-deductible donation to PolicyEngine](https://policyengine.org/us/donate)** — and use GiveCalc to see exactly how much it costs you.

---

*PolicyEngine makes free, open-source software that computes the impact of public policy on households and society.*
